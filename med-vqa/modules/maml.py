...
#-------------------------------------------------------------------------------
# Name:         maml
# Description:  simple maml with 4 conv layers
# Author:       Boliu.Kelvin
# Date:         2020/4/7
#-------------------------------------------------------------------------------
...
if __name__ == '__main__':
    simple_cnn = SimpleCNN(weight_path='./data/rad/pretrained_maml.weights', eps_cnn=1e-5, momentum_cnn=0.05)
    npo = np.random.random((3, 1, 64, 64))
